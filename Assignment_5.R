...
# Plotting occupancy and detection probability against covaraites---------------
...
# Assign shapefiles to variables for plottting
...
# This script has been modified to fully work on other people's computers.
# All required data is available through GitHub and the code is reproducible.
# Multiple steps to gather, format, and modify data in R and ArcGIS have been
# omitted for ease of use, i.e. only the minimum steps to get results are in
# this script.

# Since I am not completely finished yet (other years and parks are still missing),
# I will not archive the code on Zenodo yet. I plan on doing that in the future.
# For now, I am happy to get occupancy and detection probability results as well
# as a distribution map for White-tailed deer in Chiricahua National Monument
# in 2017.
